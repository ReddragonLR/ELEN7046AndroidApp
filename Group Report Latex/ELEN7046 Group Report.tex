...
\subsection{List of Examples} Table ~\ref{tbl:use} shows a list of the specifications by example that are applicable to the project. 
\begin{table}
  [h] \centering \caption{Table showing a list of specifications by example.} \label{tbl:use} 
  \begin{tabular}
