...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \begin{figure}[H]
    	\center{\includegraphics[width=.35\linewidth]{./images/Knight-icon}} 
    	\label{fig:Knight-icon}
    \end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{center}
  ...
  % \section{ABSTRACT}
  \end{center}
  This report focuses on a software application aimed at improving service delivery through the creation a software platform used to gather survey responses from the community. A project team if formed and requirements are established. The team followed a SCRUM methodology in creating a web platform with a web client and a native mobile device application. Through successful execution a final solution was created which met all success criteria. The project was an overall success.
...
\begin{itemize}
  ...
  \item \textbf{NodeJS:} NodeJS is a Javascript compiler. It uses an event-driven, non-blocking I/O approach that makes it efficient and lightweight \cite{NodeJS}
  \item \textbf{ExpressJS:} Express JS is a minimal web framework for Node JS applications. It provides libraries that allow for the easy development of web solutions using NodeJS \cite{ExpressJS}. The solution api is created using ExpressJS and is represented in Appendix J through a series of sequence diagrams.
...
\begin{figure}[H]
	\center{\includegraphics[width=.55\linewidth]{./images/gps}} 
